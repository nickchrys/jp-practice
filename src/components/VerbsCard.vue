...
<template>
  ...
  <div v-if="!showOptions" class="card" id="verbs-card">
    ...
    <h3>Verbs</h3>
    <p>
      <span v-if="props.cardStates['verbs-card'] == 'Japanese'" class="japanese-word" :data-hiragana="verb?.hiragana">
    ...
    <div class="lesson-selector">
      ...
      <div class="lessons-grid">
        <div v-for="lesson in availableLessons" :key="lesson">
          <input type="checkbox" :id="`verbs-${lesson}`" :value="lesson" v-model="selectedLessons" />
